...
router.post('/', authMiddleware, businessOwnerMiddleware, businessValidation, businessController.createBusiness);
...
router.put('/:id', authMiddleware, businessOwnerMiddleware, businessController.updateBusiness);
